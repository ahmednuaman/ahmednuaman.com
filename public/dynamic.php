			...
			<div id="bio">
				<div>
					...
					<div class="cols">
						...
						<p>
							Nowadays I freelance bouncing from project to project. I love it because with the uncertainty of work and the pressure of short deadlines allow me to stay driven to never say no. I love learning new things and I love working on projects that'll push me. I love working with <strong>PHP</strong>, <strong>Python</strong> (especially on AppEngine) and <strong>Ruby</strong> on the backend and <strong>HTML5</strong>, <strong>CSS3</strong>, <strong>JS</strong> (jQuery's my weapon of choice), <strong>Canvas</strong> (inc. EaselJS), <strong>WebGL</strong> (inc. three.js) and <strong>AS3</strong> (PureMVC &amp; RL) on the front end.
						</p>
						<p>
